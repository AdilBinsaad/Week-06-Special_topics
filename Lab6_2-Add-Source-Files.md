...
- ลดความซับซ้อนของโปรแกรมหลักและเพิ่มความยืดหยุ่น
...
- จำนวนไฟล์ source: 1
- ขนาด binary: 165,235 bytes
- การทำงาน: แสดงค่าจาก sensor

**ขั้นตอนที่ 2 (เพิ่ม display.c):**
- จำนวนไฟล์ source: 2
- ขนาด binary: 165,301 bytes
- การทำงาน: แสดง Display พร้อม sensor

**ขั้นตอนที่ 3 (เพิ่ม led.c):**
- จำนวนไฟล์ source: 3
- ขนาด binary: 167,581 bytes
- การทำงาน: ควบคุมไฟเปิด-ปิด กระพริบ
